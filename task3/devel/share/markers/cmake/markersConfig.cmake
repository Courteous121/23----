...
if("TRUE" STREQUAL "TRUE")
  set(markers_SOURCE_PREFIX /root/task3/src/markers)
  set(markers_DEVEL_PREFIX /root/task3/devel)
  set(markers_INSTALL_PREFIX "")
  set(markers_PREFIX ${markers_DEVEL_PREFIX})
else()
  set(markers_SOURCE_PREFIX "")
  set(markers_DEVEL_PREFIX "")
  set(markers_INSTALL_PREFIX /root/task3/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'markers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/task3/src/markers/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT markers_NUM_DUMMY_TARGETS)
      set(markers_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::markers::wrapped-linker-option${markers_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR markers_NUM_DUMMY_TARGETS "${markers_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::markers::wrapped-linker-option${markers_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND markers_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(markers_EXPORTED_TARGETS ${${markers_dep}_EXPORTED_TARGETS})
endforeach()
